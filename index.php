      ...
      <div class="container" data-aos="fade-up">
        <div class="row about-container">
          <div class="col-lg-6 content order-lg-1 order-2">
            <h2 class="title">O que é a Voluntrip?</h2>
            <p>
              A Voluntrip nasceu da necessidade de viajantes voluntários que estavam no meio de suas viagens e não conseguiam continuar a viagem, pois tinham duvidas se no próximo destino encontrariam hostel disponiveis para voluntariado.
            </p>

            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="bi bi-briefcase"></i></div>
              <h4 class="title"><a href="">Voluntariado</a></h4>
              <p class="description">Cadastre-se na Voluntrip, para enxergar as melhores oportunidades de voluntariado no seu próximo destino</p>
            </div>
